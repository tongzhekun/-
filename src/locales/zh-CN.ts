export default {
  ...
  router: {
    ...
    demandForecast_approve: '需求预估审核',
    demandForecastTotalApply: '需求预估汇总发起',
    demandForecastTotalApply_approve: '需求预估汇总审核',
    demandForecastMx: '需求预估明细查询',
    demandForecastTotalApplyMx: '需求预估汇总查询',
    issuanceProgress: '发放进度查询',
    issuanceProgressKhjl: '发放进度查询-客户经理',
    issuanceProgressKh: '发放进度查询-客户',
    historicalIssuance: '历史发放进度',
